...
public class Strategy {
    ...
    */
    ...
    public void tryRemovePassengers() {
        ArrayList<Request> finishedRequests = elevator.getFinishedRequests();
    ...
    */
    ...
    public void tryAddPassengers() {
        int currentFloor = elevator.getCurrentFloor();
        int maxPassengers = elevator.getMaxPassengers();
        Request mainRequest = elevator.getMainRequest();
        Direction direction =
                mainRequest == null
                ? getMaxDirection(currentFloor)
                : mainRequest.getDirection();
        RequestQueue waitingQueue = elevator.getWaitingQueue();
        ArrayList<Request> requests = waitingQueue.getRequestsAtFloor(currentFloor); // 获取停靠在当前楼层的请求
    ...
    public Direction getMaxDirection(int currentFloor) {
        ...
        int up = 0;
        int down = 0;
        ArrayList<Request> requests = waitingQueue.getRequestsAtFloor(currentFloor);
